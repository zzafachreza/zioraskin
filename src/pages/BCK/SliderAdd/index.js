...
export default function SliderAdd({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        axios.post(apiURL + 'slider_add', kirim).then(res => {
            setLoading(false);
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <UploadFoto onPress2={() => getGallery(1)} foto={kirim.foto} label="Upload foto Slider" />
