...
export default function Terima({ navigation }) {
    ...
    const getTransaction = () => {
        axios.post(apiURL + 'terima').then(res => {
    ...
    const __renderItem = ({ item }) => {
        ...
        return (
            <TouchableOpacity onPress={() => navigation.navigate('TerimaDetail', item)} style={{
                borderBottomWidth: 1,
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                fontSize: 11,
                                color: colors.black
                            }}>{moment(item.tanggal_terima).format('dddd, DD MMM YYYY')} Pukul {item.jam_terima}</Text>
                        </View>
    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.navigate('TerimaAdd')} style={{
                    width: 60,
                    height: 60,
                    elevation: 4,
